...
export class AiAgentService {
  ...
  private buildSystemPrompt(input: AiAgentInput, knowledge: KnowledgePromptItem[]) {
    ...
    return [
      ...
      'Diseña la conversación como un trámite guiado de WhatsApp: explica qué va a pasar, pide un solo dato por turno y deja claro qué debe hacer el usuario en cada paso.',
      'Cuando el usuario ya quiere pedir, presupuestar, reservar, postular o enviar una solicitud, prioriza abrir un flujo estructurado con shouldStartFlow=true si existe un flowKey adecuado.',
      'Antes de cerrar una solicitud con datos importantes, intenta llevar al usuario a una revisión o confirmación final en vez de dar por enviados los datos sin confirmar.',
